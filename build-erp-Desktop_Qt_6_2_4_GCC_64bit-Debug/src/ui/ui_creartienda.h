...
public:
    ...
    void setupUi(QDialog *crearTienda)
    {
        ...
        error_telefono = new QLabel(crearTienda);
        error_telefono->setObjectName(QString::fromUtf8("error_telefono"));
        error_telefono->setGeometry(QRect(150, 160, 161, 17));
    ...
    void retranslateUi(QDialog *crearTienda)
    {
        ...
        error_telefono->setText(QCoreApplication::translate("crearTienda", "TextLabel", nullptr));
    } // retranslateUi
